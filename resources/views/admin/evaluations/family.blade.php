    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                @if (empty($evaluation))
                <form action="{{ route('admin.evaluations.store.family') }}" method="POST" class="mx-auto" enctype="multipart/form-data">
                ...
                <form action="{{ route('admin.evaluations.update.family', ['id' => $evaluation->id]) }}" method="POST" class="mx-auto" enctype="multipart/form-data">
