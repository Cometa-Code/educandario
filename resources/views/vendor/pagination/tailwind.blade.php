@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex justify-between w-full px-2 items-center">
        ...
        <div class="hidden sm:flex-1 sm:flex items-center justify-between mb-0">
            <div>
