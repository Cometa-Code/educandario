        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="sm:flex">
                <div class="items-center mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form class="lg:pr-3 inline-flex" action="{{ route('families.reports') }}" method="GET">
                        ...
                        <div class="relative flex items-center ml-auto space-x-2 sm:space-x-3">
                            <div class="mr-4 inline-flex items-center text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-4 py-2">
                                <span data-bs-toggle="tooltip" data-bs-title="Selecione e clique na Lupa">Data Inicial</span>
